 ...
 * This file demonstrates how to integrate Algomind with a web frontend
 */

// For React/Vue/Angular applications
export class AlgomindClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new AlgomindClient(provider, contractAddress);
